...
<table class="table table-bordered">
	...
	<tbody>
	  <tr v-for="(point, item) in breturn.items">
	  	<td>
	  		<button class="btn btn-danger btn-sm " v-on:click.prevent="breturn.items.splice(point,1)"><i class="glyphicon glyphicon-trash"></i></button>
	  	</td>
		<td>
			<div :class="errors['breturn.items.'+ point +'.description']?'has-error btn-group bootstrap-select':'btn-group bootstrap-select'">
				...
				<div class="dropdown-menu open">
			        <ul class="dropdown-menu inner">
			          <li v-for="dbproduct in products | filterBy item.description in 'description'">
			            <a href="#" v-on:click.prevent="addItem(point, breturn.items[point].qty, breturn.items[point].discount, dbproduct)">
