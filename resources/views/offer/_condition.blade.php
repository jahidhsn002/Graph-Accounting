<table class="table table-bordered">
	<tbody>
	  <tr v-for="condition in offer.conditions">
		<td :class="errors['offer.conditions.$index.description']?'form-group has-error text-right':'form-group text-right'">@{{condition.description}}</td>
		<td :class="errors['offer.conditions.$index.description']?'form-group has-error text-right':'form-group text-right'">@{{condition.value}}</td>
	  </tr>
	  <tr>
	  	<td><button class="btn btn-warning btn-block" v-on:click.prevent="offer.conditions=[]">Clear Discount</button></td>
		<td><button class="btn btn-default btn-block" type="button" data-toggle="modal" data-target="#conditionModal">Add Discount</button></td>
	  </tr>
	</tbody>
</table>
