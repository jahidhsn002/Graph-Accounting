...
<template id="assetaccount">
			...
			<li class="active">
		   	...
		   	<li class="pull-right">
			    <div class="btn-group">
	              ...
	              <button v-show="select.length!=0" data-toggle="modal" data-target="#assets" class="btn btn-success">Edit</button>
	              <button data-toggle="modal" data-target="#assets" v-on:click.prevent="element={company_id:filtercompany},select=[],form=[]" class="btn btn-success">Add</button>
				</div>
		   	</li>
		   	<li class="pull-right">
	...
	<!-- Modal -->
	<div id="assets" class="modal" role="dialog">
	  <div class="modal-dialog modal-sm">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-header text-right">
	        <h4 class="modal-title">Asset Account Modifire</h4>
	      </div>
