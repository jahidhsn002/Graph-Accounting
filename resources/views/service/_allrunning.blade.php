<ul class="nav nav-tabs clearfix">
   	<li class="pull-right">
   		&nbsp;
    	<div class="btn-group">
    		<button v-if="Extselect.length>0" class="btn btn-success" v-on:click.prevent="page='printservice',print_id=Extelement.id">Detail / Slip</button>
		</div>
	</li>
	<li class="pull-right">
...
<table class="table table-bordered table-hover">
	...
	<tbody>
	  <tr v-for="service in estimates | filterBy search.number in 'id' |  filterBy search.date in 'date' | orderBy 'date' -1" v-on:click="ExtSelect(service.id, service)">
	  	<th>
