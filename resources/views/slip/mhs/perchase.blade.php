<div class="root" v-if="template=='mhs'&&type=='perchase'">
	<div class="page_head container-fluid text-center">
		<h2><input type="text" class="text-center" value="Purchase"></h2>
	</div>
	<div class="page_body container-fluid">
		<div class="row">
			<div class="col-xs-8">
				<h4><u>@{{data.supplier.company}}</u></h4>
			...
			<div class="col-xs-4 text-right">
				<table class="table table-bordered margin-b-0">
					...
					<tr>
						<td class="text-right col-xs-6">Memo no:</td>
						<td class="text-right col-xs-6"><input type="text" class="form-control" value="@{{data.memo}}"></td>
					</tr>
					<tr>
						<td class="text-right col-xs-6">Purchase No:</td>
